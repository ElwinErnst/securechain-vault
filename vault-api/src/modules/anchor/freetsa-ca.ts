// FreeTSA (https://freetsa.org) root CA certificate — the default trust anchor
// for RFC 3161 token chain validation when no ANCHOR_TSA_CA_PEM is configured.
// FreeTSA is the default Timestamp Authority; production using another TSA
// should configure its CA via ANCHOR_TSA_CA_PEM.
export const FREETSA_CA_PEM = `-----BEGIN CERTIFICATE-----
